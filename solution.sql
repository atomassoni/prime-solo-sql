...
SET account_balance=10.00 WHERE transactions_attempted=0 AND account_balance=0;
...
-- 8. Add a new record.
INSERT INTO syntax_practice (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('annie', 'minneapolis', 12, 10, 326763636);
